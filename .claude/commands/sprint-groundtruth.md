...
Usage: `/sprint-groundtruth <sprint-id> --deployed-commit <sha> --verdict PASS|FAIL|CONDITIONAL --notes "..."`
...
```bash
python3 scripts/sprint_lifecycle.py groundtruth <sprint-id> --deployed-commit <sha> --verdict <verdict> --notes-file /tmp/groundtruth-notes.txt
```
